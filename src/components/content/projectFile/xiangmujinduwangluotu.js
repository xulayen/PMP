...
export default class XiangMuJinDuWangLuoTu extends ContentMain {
                    ...
                    <div className="article-body">
                        <div>
                            ...
                            <h4 data-line="2" className="line" style={{ textIndent: "2em" }}>
                                项目进度网络图是表示项目进度活动之间的逻辑关系（也叫依赖关系）的图形。下图是项目进度网络图的一个示例。项目进度网络图可手工或借助项目管理软件来绘制，可包括项目的全部细节，也可只列出一项或多项概括性活动。项目进度网络图应附有简要文字描述，说明活动排序所使用的基本方法。在文字描述中，还应该对任何异常的活动序列做详细说明。
                            </h4>
                            <h4 data-line="2" className="line" style={{ textIndent: "2em" }}>
